...
RESULTADO_t obtener_mascara_red(const int bits_subred, dir_ipv4 mascara);
RESULTADO_t obtener_subred(const dir_ipv4 ip, const int bits_subred, dir_ipv4 subred);
